        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-shadow border border-gray-100">
              <h3 className="text-2xl font-bold mb-3 text-[#6a4bff]">1. A Distraction-Free Diary</h3>
              <p className="text-gray-600">Focus purely on your thoughts with our clean, English-only editor. Build a consistent writing habit without the noise. (Consistency)</p>
            </div>
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-shadow border border-gray-100">
              <h3 className="text-2xl font-bold mb-3 text-[#6a4bff]">2. Your Personal AI Tutor</h3>
              <p className="text-gray-600">Go beyond grammar checks. Get nuanced feedback from Gemini to make your expressions sound more natural and fluent. (Refinement)</p>
            </div>
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg hover:shadow-2xl transition-shadow border border-gray-100">
